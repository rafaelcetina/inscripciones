	...
	<section>
		...
		<div class="section-body">
			<div class="container-fluid">
				<h2 class="text-light text-center">Cursos disponibles<br/><small class="text-primary"> Dale un vistazo a la lista de cursos que te ofrecemos</small></h2>
				<br/>
				<?php if($cursos) {?>
				...
				<div class="row centered">
					<div class="col-md-3">
						<div class="card card-type-pricing text-center">
							...
							<div class="card-body">
								<a class="btn btn-primary" href="<?=base_url('cursos/inscribir/')?><?=$curso->id_curso?>">Seleccionar curso</a>
							</div><!--end .card-body -->
						</div><!--end .card -->
					</div><!--end .col -->
				</div><!--end .row -->
				...
				<div class="row centered">
					<div class="col-md-6">
						<div class="card card-type-pricing text-center">
							...
							<div class="card-body">
								<a class="btn btn-primary" href="<?=base_url('cursos/inscrito')?>">Ver cursos inscritos</a>
							</div><!--end .card-body -->
						</div><!--end .card -->
					</div><!--end .col -->
				</div><!--end .row -->
